...
//@FacesConverter("inheritanceConverter")
@Named
public class InheritanceConverter implements Converter {
    ...
    public Object getAsObject(FacesContext fc, UIComponent uic, String value) {
        ...
        if (value != null && value.trim().length() > 0) {
            try {
                ...
                InheritanceType i = inheritanceService.findById(id);
                return i;
    ...
    public String getAsString(FacesContext fc, UIComponent uic, Object object) {
        try {
            if(object!= null)
                return String.valueOf(((InheritanceType) object).getId());
        } catch (Exception ex) {
