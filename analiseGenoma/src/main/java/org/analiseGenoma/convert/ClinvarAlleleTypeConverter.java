...
@Named
public class ClinvarAlleleTypeConverter implements Converter {
    ...
    public Object getAsObject(FacesContext fc, UIComponent uic, String value) {
        ...
        if (value != null && value.trim().length() > 0) {
            try {
                ...
                ClinvarAlleleType i = service.findById(id);
                return i;
    ...
    public String getAsString(FacesContext fc, UIComponent uic, Object object) {
        try {
            if(object!= null)
                return String.valueOf(((ClinvarAlleleType) object).getId());
        } catch (Exception ex) {
