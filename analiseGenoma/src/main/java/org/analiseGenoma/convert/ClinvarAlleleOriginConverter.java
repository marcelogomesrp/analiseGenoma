...
@Named
public class ClinvarAlleleOriginConverter implements Converter {
    ...
    public Object getAsObject(FacesContext fc, UIComponent uic, String value) {
        ...
        if (value != null && value.trim().length() > 0) {
            try {
                ...
                ClinvarAlleleOrigin i = service.findById(id);
                return i;
    ...
    public String getAsString(FacesContext fc, UIComponent uic, Object object) {
        try {
            if(object!= null)
                return String.valueOf(((ClinvarAlleleOrigin) object).getId());
        } catch (Exception ex) {
